...
function Compresser() {
  ...
  const objectchecker = Object.values(image).every((value) =>
  ...
  return (
    <div className="mt-[45px] flex flex-col gap-4">
      <div className="flex items-center flex-col gap-4">
        <h1 className="uppercase font-semibold text-center text-[40px]">
          image compresser
        </h1>
        <div className="mb-[50px] flex md:flex-row sm:flex-col gap-6">
          <label
            htmlFor="file-upload"
            className="bg-sky-400 py-2 px-5 rounded-lg capitalize"
          >
            Upload Image
          </label>
          <input
          ...
          {compressedimage.ok ? (
            <a
              className="bg-sky-400 text-center py-2 px-6 rounded-lg capitalize"
              rel="noreferrer"
              target="_blank"
              href={
                compressedimage.ok
        ...
        <div>
          {objectchecker ? (
            <div className="flex flex-col gap-9">
              <img
                src={image.dataurl}
                className="max-w-[490px] max-h-[490px] shadow-2xl p-5 rounded-2xl"
                alt=""
              />
              <div className="grid sm:grid-cols-2 md:grid-cols-3">
                <div className="flex flex-col  items-center">
                  <h1>name</h1>
                  <p className="w-[150px] text-center text-ellipsis whitespace-nowrap overflow-hidden">
                    {image.filename}
                  </p>
                </div>
                <div className="flex flex-col  items-center">
              ...
              <div>
                <div className="flex flex-col gap-9">
                  ...
                  <div className="grid sm:grid-cols-2 md:grid-cols-3">
                    ...
                    <div className="flex flex-col  items-center">
                      <h1>type</h1>
                      <p>{compressedimage.type}</p>
                    </div>
                    <div className="sm:col-span-2 md:col-span-1 flex flex-col items-center">
                      <h1>size</h1>
                      <p>{compressedimage.size}</p>
                    </div>
                  </div>
                </div>
              </div>
